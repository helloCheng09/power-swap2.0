  ...
  <a-layout-header>
    ...
    <div class="header-col header-nav">
      ...
      <a-menu mode="horizontal" class="menu-large">
        <a-menu-item>
          <router-link to="/panel" class="nav-link" @click="e => e.preventDefault()">
            <svg-icon name="dashboard1" class="dh_icon_menu" />
            <span>Dashboard</span>
          </router-link>
        </a-menu-item>
        <a-menu-item>
          <router-link to="/panel" class="nav-link" @click="e => e.preventDefault()">
            <svg-icon name="user" class="dh_icon_menu" />
            <span>Profile</span>
          </router-link>
        </a-menu-item>
        <a-menu-item>
          <router-link to="/panel" class="nav-link" @click="e => e.preventDefault()">
            <svg-icon name="sign-in" class="dh_icon_menu" />
            <span>Sign In</span>
          </router-link>
        </a-menu-item>
        <!--        <a-menu-item>-->
        ...
        <!--                <g id="Tables" class="fill-muted" transform="translate(-58.000000, -507.000000)" fill="#BFBFBF" fill-rule="nonzero">-->
        ...
        <!--                        <path id="Path" d="M4,6 C4,4.89543 4.89543,4 6,4 L12,4 C13.1046,4 14,4.89543 14,6 L14,12 C14,13.1046 13.1046,14 12,14 L6,14 C4.89543,14 4,13.1046 4,12 L4,6 Z" />-->
        <!--                        <path id="Path" d="M2,0 C0.89543,0 0,0.89543 0,2 L0,8 C0,9.1046 0.89543,10 2,10 L2,4 C2,2.8954305 2.8954305,2 4,2 L10,2 L10,2 C10,0.89543 9.1046,0 8,0 L2,0 Z" />-->
        <!--                      </g>-->
        <!--                    </g>-->
        <!--                  </g>-->
        <!--                </g>-->
