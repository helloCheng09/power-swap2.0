<template>
  ...
  >
    ...
    <div class="drawer-content">
      ...
      <!--        <h6>Sidebar Color</h6>-->
      <!--        <a-radio-group v-model="sidebarColorModel" default-value="primary" @change="$emit('updateSidebarColor', $event.target.value)">-->
      <!--          <a-radio-button value="primary" class="bg-primary" />-->
      <!--          <a-radio-button value="secondary" class="bg-secondary" />-->
      <!--          <a-radio-button value="success" class="bg-success" />-->
      <!--          <a-radio-button value="danger" class="bg-danger" />-->
      <!--          <a-radio-button value="warning" class="bg-warning" />-->
      <!--          <a-radio-button value="black" class="bg-dark" />-->
      <!--        </a-radio-group>-->
      <!--      </div>-->
      <!--      <div class="sidenav-type">-->
      <!--        <h6>Sidenav Type</h6>-->
      <!--        <p>Choose between 2 different sidenav types.</p>-->
      <!--        <a-radio-group v-model="sidebarThemeModel" button-style="solid" default-value="primary" @change="$emit('updateSidebarTheme', $event.target.value)">-->
      ...
      <!--        &lt;!&ndash;        <gh-btns-star slug="creativetimofficial/muse-vue-ant-design-dashboard" show-count />&ndash;&gt;-->
      <!--      </div>-->
      <!--      <div class="sharing">-->
